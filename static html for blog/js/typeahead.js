(function($) {
    ...
    var oParser = function() {
        ...
        function getRemote(o) {
            ...
            if (remote = o.remote || null) {
                ...
                remote.ajax.beforeSend = function(){};
                remote.ajax.complete = function(){};
    ...
    var Input = function() {
        ...
        function Input(o) {
            ...
            this.$hint = $(o.hint);
            this.$input = $(o.input).on("keydown.tt", onKeydown);
            ...
            if (!_.isMsie()) {
                ...
                this.$input.on("keydown.tt keypress.tt cut.tt", function($e) {
        ...
        _.mixin(Input.prototype, EventEmitter, {
            ...
            _checkInputValue: function checkInputValue() {
                ...
                //inputValue = inputValue.replace('http:', '');
